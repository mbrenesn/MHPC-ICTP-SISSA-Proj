...
int main(int argc, char **argv)
{
  ...
  Basis basis(l,n);
  LLInt *int_basis = new LLInt[basis.basis_size()];
  basis.construct_int_basis(int_basis);
  
  //std::cout << "After constructing integer basis" << std::endl;
  ...
  //std::cout << "After constructing Hamiltonian matrix" << std::endl;
  //PetscMemoryGetCurrentUsage(&mem);
  //std::cout << "Process memory " << mem / (1024 * 1024) << " MB" << std::endl;
  ...
  //std::cout << "After deallocating int basis" << std::endl;
  //PetscMemoryGetCurrentUsage(&mem);
  //std::cout << "Process memory " << mem / (1024 * 1024) << " MB" << std::endl;
